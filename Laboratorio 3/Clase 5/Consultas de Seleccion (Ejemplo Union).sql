...
--Order By como siempre va al final puede usar nombres de tablas creadas en la consulta
...
--Al usar Union:
-- *La cantidad de columnas siempre tiene que ser la misma 
-- *El tipo de datos en las tablas siempre tiene que ser el mismo entre consultas
